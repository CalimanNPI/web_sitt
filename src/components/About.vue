<template>
  ...
  <div
    id="Nosotros"
    class="about container mx-auto flex flex-col items-center px-4 py-16 text-center md:py-20 md:px-10 lg:px-20 xl:max-w-4xl"
  >
    <div class="border-r-4 border-azul-500 w-50">
      <p
        ...
        class="px-8 mt-8 mb-12 text-lg font-semibold text-gray-700"
      >
        Quienes somos
      </p>
    </div>
    <h1
      ...
      data-aos-easing="linear"
      data-aos-duration="500"
      class="text-4xl font-bold leadi sm:text-6xl text-gray-700"
    >
      Somos una empresa 100% mexicana, especializada en
      <span class="text-azul-400"
        >servicio de transporte ejecutivo y turístico.</span
      >
    </h1>
  </div>
          ...
          <ul role="list" class="mt-8 space-y-8 text-gray-600">
            <li class="flex gap-x-3">
              <svg
                ...
                viewBox="0 0 300 300"
                class="mt-1 h-10 w-10 flex-none text-azul-500"
              >
                <path
                  fill="#1E88E5"
