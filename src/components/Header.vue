<template>
  <div :class="[
    ...
    <div class="relative flex items-center justify-between">
      <a @click="goToTop()" href="#" aria-label="Company" title="Company" class="inline-flex items-center">
        <img v-if="scrollPosition < 500" src="/src/assets/logos/logo_ba.png" class="h-20 mr-3" />
        <img v-if="scrollPosition > 500" src="/src/assets/logos/logo_na.png" class="h-20 mr-3" />
        <!--Logo
        ...
        <div v-if="isMenuOpen" class="absolute top-0 left-0 w-full text-gray-200 bg-gray-900">
          <div class="p-5 border rounded shadow-sm">
            <div class="flex items-center justify-between mb-4">
              <div>
                <a href="/" aria-label="Company" title="Company" class="hover:scale-125 inline-flex items-center">
  ...
  <div class="relative heroe">
    <video src="/src/assets/video16.mp4" autoplay loop muted
      class="absolute inset-0 object-cover w-full h-full"></video>
    ...
    <div class="relative bg-gray-950 bg-opacity-60 flex items-center">
      <div class="my-20 mx-auto sm:max-w-xl md:max-w-full lg:py-20">
        <div class="w-full mb-12 xl:mb-0 flex flex-col justify-center items-center text-gray-100">
          ...
          <section class="bg-white">
            <div class="lg:grid lg:min-h-screen lg:grid-cols-12">
              <section class="relative flex h-32 items-end bg-gray-900 lg:col-span-5 lg:h-full xl:col-span-6">
                <img alt="Night" src="/src/assets/contact.jpg"
                  class="absolute inset-0 h-full w-full object-cover opacity-80" />

                <div class="hidden lg:relative lg:block lg:p-12">
                  <h2 class="mt-6 text-4xl font-extrabold leading-none tracking-tight text-white">
                    Bienvenidos a SITT Ejecutivo
                  </h2>

                  <p class="mt-4 text-base font-medium tracking-wider leading-relaxed text-white/90">
              ...
              <main
                ...
                <div class="max-w-xl lg:max-w-3xl">
                  <div class="mt-16 block lg:hidden">
                    <h1 class="mt-2 text-4xl font-extrabold leading-none tracking-tight text-gray-900 ">
                      Bienvenidos a SITT Ejecutivo
                    </h1>

                    <p class="mt-4 text-base font-medium tracking-wider leading-relaxed text-gray-500">
                      Contamos con un equipo multidisciplinario, capacitado y
                      certificado, que domina a la perfección cada área,
                      permitiendo ofrecer atención personalizada y de calidad a
                      nuestros clientes.
                  ...
                  <div role="alert" :class="isSendEmail ? '' : 'hidden'">
                    <div :class="errorSend ? 'border-rose-700' : 'border-green-700'"
                      ...
                      <div class="flex items-start gap-4 pl-10">
                        ...
                        <div class="flex-1">
                          ...
                          <p class="mt-1 text-sm text-gray-700" v-if="!errorSend">
                            Gracias por comunicarte con nosotros, en breve nos comunicaremos con usted. 👩‍💻📣
                          </p>
                          <p class="mt-1 text-sm text-gray-700" v-if="errorSend">
                        ...
                        <button @click="reset()" class="text-gray-500 transition hover:text-gray-600">
                  ...
                  <form ref="form" action="#" class="mt-8 grid grid-cols-12" @submit.prevent="sendEmail()">
                    <div class="flex flex-row my-10">
                      <p class="flex items-center mr-2 sm:mr-6">
                        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100"
                          viewBox="0,0,256,256" class="w-10 h-10 mr-2 sm:mr-6">
                          <g fill="#1e88e5" fill-rule="nonzero" stroke="none" stroke-width="1" stroke-linecap="butt"
                      ...
                      <p class="flex items-center mr-2 sm:mr-6">
                        ...
                        <span class="text-base font-extrabold leading-none tracking-tight">contacto@sittejecutivo.com</span>
                      </p>
                    </div>

                    <div class="col-span-12 mt-2">
                      <label for="name" class="block text-lg font-extrabold leading-none tracking-tight text-gray-700">
                        Nombre
                      </label>
                    ...
                    <div class="col-span-12 mt-2">
                      <label for="email" class="block text-lg font-extrabold leading-none tracking-tight text-gray-700">
                        Correo electrónico
                      </label>
                    ...
                    <div class="col-span-12 mt-2">
                      <label for="message" class="block text-lg font-extrabold leading-none tracking-tight text-gray-700">
                        Mensaje
                      </label>

                      <textarea class="mt-2 w-full rounded-lg border-gray-200 align-top shadow-sm sm:text-sm" rows="4"
                        placeholder="Mensaje ..." v-model="message" id="message" name="message"></textarea>
                    </div>
                    ...
                    <div class="col-span-6 sm:flex sm:items-center sm:gap-4 mt-6">
                      ...
                      <p class="mt-4 text-lg font-extrabold leading-none tracking-tight text-gray-500 " data-modal-hide="defaultModal">
                        Cancelar
                      </p>
                    </div>
                  </form>
